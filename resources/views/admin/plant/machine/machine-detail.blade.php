        ...
        <div class="row justify-content-end">
            <div class="col-12 col-lg-6 d-flex justify-content-between justify-content-lg-end">
                <form action="{{route('admin.plant-machine-delete',[
                    ...
                    <button type="submit" class="btn bg-base text-white mt-2 mt-md-0 mt-lg-0" onclick="return confirm('Are you sure?')">Hapus Engine</button>
                </form>
            </div>
        </div>
                        ...
                        <form action="{{route('admin.plant-machine-filter-noise',[
                            ...
                            <div class="row justify-content-start mx-0">
                                <div class="col-12 mb-2 mb-lg-3 col-lg-6 pl-0">
                                    <input type="text" class="form-control" placeholder="Nomer Engine" name="code">
                                </div>
                                <div class="col-12 mb-2 mb-lg-3 col-lg-6 pl-0">
