...
<main id="dashboard">
    <div class="col-12 bg-white p-4  mb-xs-60">
        <form action="{{route('admin.plant-machine-update',[
            ...
            <div class="row mt-5">
                <div class="col-12 col-lg-4 px-0 px-lg-2 rounded border-doted mb-4 mb-lg-0 p-4 d-flex align-items-center justify-content-center" id="input-image-preview" style="background-image: url({{ asset('storage/machine_image/'.$data['machine']['image']) }}); background-size:cover">
