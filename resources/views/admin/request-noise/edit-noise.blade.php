        ...
        <form action="{{route('admin.request-noise.update',[
            ...
            <div class="form-group mb-4">
                ...
                <select class="form-select" aria-label="Default select example">
                    ...
                    @endforeach
                    <input type="hidden" name="symton_noise" required id="symton_noise" value="{{$data['noise']['symton_noise']}}">
                </select>
            </div>
            <div class="form-group mb-4">
                <p>Area<span id="required">*</span></p>
                <select class="form-select" aria-label="Default select example" name="area" required value="{{$data['noise']['area']}}">
            ...
            <div class="form-group mb-4 {{$data['noise']['method'] != 'Idle' ? 'd-block' : 'd-none'}}" id="at-gear-wrap">
                <p>At Gear</p>
                <select class="form-select" aria-label="Default select example">
                ...
                <input type="hidden" name="at_gear" id="at-gear" value="{{$data['noise']['at_gear']}}">
            </div>
            @endif
