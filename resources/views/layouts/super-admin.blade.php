        ...
        <header class="topbar bg-white" data-navbarbg="skin5">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header py-2" data-logobg="skin6">
                    ...
                    <!-- Logo -->
                    <!-- ============================================================== -->
                    <a class="navbar-brand w-xs-50" href="{{route('super-admin.user.index', ['role' => 'all'])}}">
                        <!-- Logo icon -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item pt-2">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('super-admin.user.index',['role' => 'all'])}}" aria-expanded="false">
        ...
        <div class="page-wrapper">
            ...
            <div class="fixed-bottom d-block d-md-none d-lg-none" id="bottom-menu-mobile">
                <div class="row align-items-center justify-content-between pt-2 px-2 shadow-lg">
                    <div class="col-3">
                        <a href="{{route('super-admin.user.index', ['role' => 'all'])}}" class="text-decoration-none">
